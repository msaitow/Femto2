...
//  SQnetwork.hpp
//  
//  Container that represents network of objects
//
...
namespace femto {
  ...
  /////////////////////////////////////////////////////////////
  // Container template for a stream of binary contractions
  /////////////////////////////////////////////////////////////
  template<class T>
  class SQnetwork{
  ...
  private:
    tree<T> t_;
  public:
    const tree<T> &t() const { return t_; };
    tree<T> &t() { return t_; };
  ///////////////////////////////////////////////////////////
  ...
  public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    SQnetwork() {}
    SQnetwork(tree<T> const & ts)      { t_ = ts; }
    SQnetwork(SQnetwork<T> const & ts) { t_ = ts.t(); }
    SQnetwork(T const & t1)
    { 
